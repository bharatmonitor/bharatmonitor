...
import { validateHardcodedCred, validateSupabaseStoredCred } from '@/lib/accounts'
...
export default function AuthPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      // 1. Try hardcoded + localStorage credentials (instant, no network)
      //    This covers: built-in accounts, God-Mode created accounts, password-updated accounts
      ...
      // 2. Check Supabase accounts table — handles cross-device logins for God-Mode accounts
      ...
      // 3. Try Supabase Auth for real Supabase-registered accounts
