...
export interface Account {
  ...
  // Social media watchlist — handles auto-tracked across X/Bluesky/Meta
  watchlist_handles: WatchlistHandle[]
...
export interface WatchlistHandle {
  id: string
  handle: string              // e.g. '@svaradarajan' or 'svaradarajan.bsky.social'
  display_name?: string       // e.g. 'Siddharth Varadarajan'
  platform: 'twitter' | 'bluesky' | 'instagram' | 'meta' | 'all'
  category: 'journalist' | 'politician' | 'commentator' | 'influencer' | 'custom'
  is_active: boolean
  added_at: string
}
...
export interface FeedItem {
  ...
  channel?: string
  // Content metadata
  keyword?: string           // tracked keyword that surfaced this item
  tone?: number              // numeric tone score (-5 to +5)
  ai_summary?: string        // Claude-generated summary
  opp_risk?: number          // opposition attack risk 0-100
