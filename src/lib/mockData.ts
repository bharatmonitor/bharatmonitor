...
export const BASIC_ACCOUNT: Account = {
  ...
  contact_email: 'ops@basic-demo.in', email: 'ops@basic-demo.in', created_at: '2024-01-15T10:00:00Z', updated_at: new Date().toISOString(),
}
...
export const RAILWAYS_ACCOUNT: Account = {
  ...
  tracked_politicians: [],
  watchlist_handles: [], // No political competition — ministry mode
...
export const RAILWAYS_AI_BRIEF: AIBrief = {
  ...
  opportunities: [
    {
      id: 'ro1', type: 'contradiction', politician: 'Media/Opposition Safety Claim',
    ...
    {
      id: 'ro2', type: 'contradiction', politician: 'Privatisation Narrative',
    ...
    {
      id: 'ro3', type: 'contradiction', politician: 'Punctuality Claim',
...
export const DEMO_AI_BRIEF: AIBrief = {
  ...
  opportunities: [
    { id: 'o1', type: 'flip', politician: 'Arvind Kejriwal', score: 91, description: 'Condemning electoral bonds while AAP received ₹10 crore — ECI filing on record', current_statement: 'BJP electoral bonds = biggest corruption', historical_statement: 'AAP received ₹10cr bonds — EC filing Sep 2022', confidence: 0.91 },
    { id: 'o2', type: 'contradiction', politician: 'Akhilesh Yadav', score: 85, description: '"Worst inflation in 40 years" vs RBI data: current 4.8% vs UPA-2 average 9.4%', current_statement: 'Worst inflation in 40 years under Modi', historical_statement: 'UPA-2 CPI averaged 9.4% for 5 years — RBI Annual Report', confidence: 0.85 },
    { id: 'o3', type: 'contradiction', politician: 'Mamata Banerjee', score: 72, description: 'Federalism claim vs Finance Commission: WB received record ₹1.23L crore devolution in FY24', current_statement: 'States reduced to beggars at Delhi\'s door', historical_statement: 'WB received record ₹1.23L crore central devolution FY24', confidence: 0.72 },
  ],
  ticker_items: [
